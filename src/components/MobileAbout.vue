<template>
  <div class="mobile-about-container">
    <div class="mobile-about-header">
      <div class="mobile-about-omar">
        Omar Mohammad
        <div class = "mobile-omar-sub">designer/programmer/artist</div>
      </div>
      <img @click = "checkMobilePage" id="mobile-arrow-about" :src="this.backButton" alt="">
    </div>
    <div class="mobile-info-about">
      <div class="info-about">
        <div>
          ...
          He is a designer, programmer, and artist. <br><br> HIS WORK OSCILLATES BETWEEN CULTURAL/COMMERCIAL AND SELF-INITIATED PROJECTS. WORKING WITH GRAPHICS, ARCHITECTURE, THE INTERNET, CODE, AND SPECULATIVE/CRITICAL STUDIES, HE DESIGNS AND PROGRAMS APPS, BOOKS, EXHIBITIONS, IDENTITIES, OBJECTS, AND WEBSITES.
...
export default {
  data() {
    return {
      backButton: "assets/arrow-black.png",
    }
  },
  methods: {
    checkMobilePage() {
